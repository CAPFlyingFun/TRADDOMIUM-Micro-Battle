...
/** Every probe that seeds a save the way probe-shot does. `probe-objects` copied the trick and the literals; `probe-sky`, `probe-ecology` and `probe-lighting` copied them again. */
const PROBES = ['probe-shot.mjs', 'probe-objects.mjs', 'probe-sky.mjs', 'probe-ecology.mjs', 'probe-lighting.mjs'];
